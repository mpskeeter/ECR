...
export interface AdvancedSecurity extends BaseStatus {}

export interface SecretScanning extends BaseStatus {}

export interface SecretScanningPushProtection extends BaseStatus {}
...
export interface GithubRepository extends BaseEntity {
  // id: number,
  // name: string,
  node_id: string;
  full_name: string;
